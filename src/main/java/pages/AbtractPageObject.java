...
public class AbtractPageObject extends AbstractPage {
	...
	public void clearAndInputDataWithDynamicTextbox(String dataValue, String textboxName) {
		...
		clearAndSendKeyToElementDynamicTextbox(driver, AbstractPageUI.DYNAMIC_TXT, dataValue, textboxName);
	}

	public void clearAndInputKeyWithDynamicTextbox(Keys key, String textboxName) {
		waitForControlVisible(driver, AbstractPageUI.DYNAMIC_TXT, textboxName);
		clearAndSendKeyPressToElementDynamicTextbox(driver, AbstractPageUI.DYNAMIC_TXT, key, textboxName);
	}

	public void inputDataWithDynamicTextbox(String dataValue, String textboxName) {
		waitForControlVisible(driver, AbstractPageUI.DYNAMIC_TXT, textboxName);
		sendKeyToElementDynamicTextbox(driver, AbstractPageUI.DYNAMIC_TXT, dataValue, textboxName);
	}
	...
	public void selectDynamicDropdown(String dataValue, String dropdownName) {
		...
		selectItemInDynamicDropdown(driver, AbstractPageUI.DYNAMIC_DROPDOWN, dataValue, dropdownName);
	}
